...
async function fetchDataAndDisplay() {
    try {
        ...
        const catDocRef = doc(collection(db, 'rooms'), 'rabbit');
        const catRoomsCollectionRef = collection(catDocRef, 'rabbit rooms');
            ...
            try {
                ...
                const roomHTML = `
                    <div class="rooms-container">
                        ...
                        <img class="card-img-top" src="/image/rabbit/${imageUrl}" alt="${roomData.room_name}" style="height:280px">
